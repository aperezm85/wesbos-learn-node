...
exports.getStores = async (req, res) => {
  ...
  if (!stores.length && skip) {
    req.flash(
      "info",
      `Hey! You asked for page ${page}. But that doesn't exist. So I put you on the page ${pages}`
    );
...
exports.updateStore = async (req, res) => {
  ...
  const data = req.body;
  const store = await Store.findOneAndUpdate(query, data, {
